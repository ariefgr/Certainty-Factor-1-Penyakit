<title>Diagnosa - SisPak AI</title>
<?php
switch ($_GET['act']) {
...
// --------------------- END -------------------------
	...
	<h2 class='text text-primary'>Hasil Diagnosis &nbsp;&nbsp;<button id='print' onClick='window.print();' data-toggle='tooltip' data-placement='right' title='Klik tombol ini untuk mencetak hasil diagnosa'><i class='fa fa-print'></i> Cetak</button> </h2>
      ...
      echo "</table><div class='well well-small'><h3>Hasil Diagnosa</h3>";
      echo "<div class='callout callout-default'>Berdasarkan Perhitungan aplikasi maka Bebek anda Terdiagnosa<b><h3 class='text text-success'></b>  " . round($vlpkt[1], 2)*100 . " % (" . $vlpkt[1] . ") <br></h3> yang berarti : ";
      if ($cflama <=0){
      	echo "Bebek anda Tidak Terdiagnosa penyakit Flu Burung" ;
      }else if($cflama <=0.5){
      	echo "Bebek anda Kemungkinan Kecil Terdiagnosa penyakit Flu Burung <br>
        Selalu Lakukan Vaksinasi";
      }else if($cflama <=0.79){
      	echo "Bebek anda Kemungkinan Terdiagnosa penyakit Flu Burung <br>
        Pisahkan Itik yang terkena penyakit";
      }else if($cflama <=0.99){
        echo "Bebek anda Kemungkinan Besar Terdiagnosa penyakit Flu Burung <br>
        Laporkan ke Dinas Peternakan guna Uji Lab lebih lanjut";
      }else{
        echo "Sangat Yakin <br>
        Laporkan ke Dinas Peternakan guna Uji Lab dan dilakukan Pemusnahan";
      }
	 ...
	 <div class='alert alert-success alert-dismissible'>
                ...
                Silahkan memilih gejala sesuai dengan kondisi Bebek anda, anda dapat memilih kepastian kondisi Bebek dari pasti tidak sampai pasti ya, jika sudah tekan tombol proses (<i class='fa fa-search-plus'></i>)  di bawah untuk melihat hasil.
              </div>
      ...
      while ($r3 = mysql_fetch_array($sql3)) {
        ...
        echo '<td class="opsi"><select name="kondisi[]" id="sl' . $i . '" class="opsikondisi"  required/><option data-id="0" ></option>';
