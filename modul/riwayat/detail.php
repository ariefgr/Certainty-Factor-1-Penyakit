<title>Detail Riwayat - SisPak AI</title>
<?php
...
// --------------------- END -------------------------
  ...
  if ($vlpkt[1] <=0){
    ...
    echo "Bebek anda Kemungkinan Kecil Terdiagnosa penyakit Flu Burung";
  }else if($vlpkt[1] <=0.79){
    echo "Bebek anda Kemungkinan Terdiagnosa penyakit Flu Burung";
  }else if($vlpkt[1] <=0.99){
    echo "Bebek anda Kemungkinan Besar Terdiagnosa penyakit Flu Burung";
  }else{
    echo "Sangat Yakin";
  }
