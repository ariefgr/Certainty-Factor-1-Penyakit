  ...
  <html><head>
      ...
      <base href="http://localhost/sispak/">
      ...
      <div class="wrapper">
        ...
        <header class="main-header">
          ...
          <a href="./" class="logo">
            ...
            <span class="logo-mini"><b>AI</span>
            <!-- logo for regular state and mobile devices -->
            <span class="logo-lg"><b>SisPak AI</b></span>
          </a>
          <!-- Header Navbar -->
                        ...
                        <li class="user-header">
                          ...
                          <p>
                           Login sebagai <?php echo ucfirst($_SESSION['username']); ?>
                            <small>Pakar dari SisPak AI</small>
                          </p>
                        </li>
                        <!-- Menu Body -->
                        <li class="user-body">
  ...
  function kirimContactForm(){
      ...
      if(nama.trim() == '' ){
          ...
          <strong><div class="cinta">Copyright © 2019 - A Gilang R</a></div></strong>
        </footer>
